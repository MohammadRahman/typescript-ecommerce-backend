...
export async function createProductHandler(req: Request<{}, {}, ProductBodyValidation['body']>, res: Response) {
  try {
    //! get userId
...
export async function findOneProduct(req: Request<FindProduct['params']>, res: Response) {
  try {
    const { id } = req.params
    ...
    } else { return res.status(StatusCodes.OK).send(product) }
...
export async function updateProduct(req: Request<FindProduct['params']>, res: Response) {
  try {
    ...
    const updateProduct = await findOneAndUpdateProductService({ id }, { ...update }, { new: true })
    return res.status(StatusCodes.OK).json({ message: 'productUpdated', updateProduct })
...
export async function deleteProductHandler(req: Request<FindProduct['params']>, res: Response) {
  try {
